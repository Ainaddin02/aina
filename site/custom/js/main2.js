...
var PointType = ['ATM', 'Tree', 'Telephone Poles', 'Electricity Poles']; // dynamically
...
var myview = new ol.View({
    center: [7951952.468613067, 6640760.108854465],
    zoom: 11
})
...
var featureLayersourse = new ol.source.TileWMS({
    url: 'http://localhost:8080/geoserver/sewerage_app/wms',
    params: { 'LAYERS': 'sewerage_app:drawnFeature', 'tiled': true },
